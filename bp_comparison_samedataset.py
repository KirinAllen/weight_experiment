...
def weight_comparison():
    for i in range(epoch_num):
        ...
        bp2_weights1 = np.matrix(bp2_weights_array1.reshape(784, 200))
...
if __name__ == "__main__":
    ...
    (X2_train,y2_train),(X2_test,y2_test) = mnist.load_data() #加载mnist数据,比较同一个数据集
    ...
    num_pixels2 = X2_train.shape[1] * X2_train.shape[2] # mnist
    #mnist1
